...
import { requestAdminMfaResetAction } from "@/app/actions/admin";
import { BrandLockup } from "@/components/BrandLockup";

type ResetMfaPageProps = {
...
export default async function ResetMfaPage({ searchParams }: ResetMfaPageProps) {
    ...
    <main className="flex min-h-screen items-center justify-center px-4 py-10">
      <section className="w-full max-w-md overflow-hidden rounded-lg bg-white shadow-sm ring-1 ring-[#d8def0]">
        ...
        <div className="p-6">
          ...
          <h1 className="mt-4 text-2xl font-semibold">Redefinir MFA</h1>
          <p className="mt-2 text-sm leading-6 text-[#5d6480]">
            Informe o e-mail cadastrado na equipe administrativa. Se o e-mail estiver ativo, enviaremos um link para
            redefinir o autenticador.
          </p>
          ...
          <form action={requestAdminMfaResetAction} className="mt-5 space-y-4">
